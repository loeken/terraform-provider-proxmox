...
$ go install github.com/loeken/terraform-provider-proxmox/cmd/terraform-provider-proxmox
```
...
Use the format: [host.domain]/loeken/proxmox/[version]/[arch].
...
$ mkdir -p ~/.terraform.d/plugins/registry.example.com/loeken/proxmox/1.0.0/${PLUGIN_ARCH}
```
...
```shell
$ cp bin/terraform-provider-proxmox ~/.terraform.d/plugins/registry.example.com/loeken/proxmox/1.0.0/${PLUGIN_ARCH}/
$ ls -al ~/.terraform.d/plugins/registry.example.com/loeken/proxmox/1.0.0/${PLUGIN_ARCH}/
...
- Finding registry.example.com/loeken/proxmox versions matching ">= 1.0.0"...
- Installing registry.example.com/loeken/proxmox v1.0.0...
- Installed registry.example.com/loeken/proxmox v1.0.0 (unauthenticated)
